package com.example.petprojectjus.celebrity.presentation.celebrity.adapter.trending
...
import com.example.petprojectjus.databinding.TrendingCelebrityItemBinding
import com.example.petprojectjus.movie.presentation.IMAGE_URL
import com.squareup.picasso.Picasso

class TrendingAdapter : ListAdapter<CelebrityDvo, TrendingViewHolder>(CelebrityDiffCallback) {

    var onCelebrityClickListener: OnCelebrityClickListener? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TrendingViewHolder {
        return TrendingViewHolder(
            TrendingCelebrityItemBinding.inflate(
